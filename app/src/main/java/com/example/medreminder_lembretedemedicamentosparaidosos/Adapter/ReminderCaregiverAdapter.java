...
public class ReminderCaregiverAdapter extends RecyclerView.Adapter<ReminderCaregiverAdapter.MyViewHolder> {
    ...
    public ReminderCaregiverAdapter(List<Reminder> reminders, Context context, SharedPreferences sp, MenuActivity menuActivity) {
    ...
    @NonNull
    @Override
    public ReminderCaregiverAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.items_reminders_caregiver_layout, parent, false);
        return new ReminderCaregiverAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ReminderCaregiverAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textNameMedicine, textTime, textDose, textDate, textElderly;
